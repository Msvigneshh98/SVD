...
# **Import the data**
University = pd.read_excel(r"C:\Users\Bharani Kumar\Downloads\svd (1)\svd\University_Clustering.xlsx")
University
...
newdf = pd.read_excel(r"C:\Users\Bharani Kumar\Downloads\svd (1)\svd\new_Univ_4_pred.xlsx")
newdf
